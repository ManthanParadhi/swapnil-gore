...
const Navigation = () => {
  return (
    <div>
      <nav className="h-4/5 w-1/6 fixed top-0">
        <ul className="m-8">
          <NavItems to="/">
            <svg
          ...
          <NavItems to="/events">EVENTS</NavItems>
          <NavItems to="/library">LIBRARY</NavItems>
          <NavItems to="/">SUBSCRIBE</NavItems>
